					...
					<table className="w-full text-muted-foreground text-sm">
						<thead>
							<tr className="border-b">
								<th className="p-4 text-left font-bold whitespace-nowrap">Doorprize</th>
								<th className="p-4 text-center font-bold whitespace-nowrap">Winner</th>
							</tr>
						</thead>
						<tbody>
